...
def BrickPiSetTimeout():
    for i in range(2):
        ...
        Array[BYTE_TIMEOUT + 1] = int((BrickPi.Timeout / 256     )) & 0xFF
        Array[BYTE_TIMEOUT + 2] = int((BrickPi.Timeout / 65536   )) & 0xFF
        Array[BYTE_TIMEOUT + 3] = int((BrickPi.Timeout / 16777216)) & 0xFF
